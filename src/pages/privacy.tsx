...
const PrivacyPolicy = () => {
  return (
    <Container maxW={['2xl']} my={10} mx="auto">
      <Box bg="gray.800" rounded="md" py={4} px={10} mx={5}>
        <Heading as="h2" pt={4} pb={4} fontSize="2xl">
          Privacy Policy
        </Heading>
        <Text>Last updated: June 15, 2022</Text>
        <br />
        <Text>
        ...
        <Text>
          ...
          <NextLink href="https://www.privacypolicies.com/privacy-policy-generator/" passHref>
            <Link color="blue.200" target="_blank" rel="noreferrer">
        ...
        <Heading as="h2" pt={4} pb={4} fontSize="lg">
          Interpretation
        </Heading>
        <Text>
        ...
        <UnorderedList>
          ...
          <ListItem>
            <Text>
              <strong>Website</strong> refers to LifeHack 2022, accessible from{' '}
              <NextLink href="https://lifehack.nuscomputing.com/" passHref>
                <Link color="blue.200" target="_blank" rel="external nofollow noopener noreferrer">
                  https://lifehack.nuscomputing.com/
                </Link>
              </NextLink>
            </Text>
          </ListItem>
        ...
        <Heading as="h3" pt={2} pb={2} fontSize="md">
          Personal Data
        </Heading>
        <Text>
        ...
        <UnorderedList>
          ...
          <ListItem>
            ...
            <NextLink
              ...
              passHref
            >
              <Link color="blue.200" target="_blank">
        ...
        <UnorderedList>
          <ListItem>
            ...
            <NextLink href={'mailto:lifehack@nuscomputing.com'} passHref>
              <Link color="blue.200">lifehack@nuscomputing.com</Link>
            </NextLink>
          </ListItem>
        </UnorderedList>
      </Box>
