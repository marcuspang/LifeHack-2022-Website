      ...
      <Section bg="theme.100" heading={'FAQ'}>
        <Box textAlign="left" maxW="700px" fontSize="xl" m="20px auto">
          <Box mt="10">
            ...
            <Text>
              This event is open to all current Polytechnic, Junior College and
              ITE students, students awaiting entry to University, and all
          ...
          <Box mt="10">
            ...
            <Text>
              Some knowledge of programming is recommended but not necessary! We
              have workshops planned for you from 4 - 8 July. Attending the
              workshops will provide you with resources and ideas to help you
              conceptualize and create your hack.
            </Text>
          </Box>
          <Box mt="10">
            <Heading size="lg">Am I eligible to participate?</Heading>
          ...
          <Box mt="10">
            ...
            <Text>
              ...
              lifehack@nuscomputing.com and we can try to match you up with
              someone.
            </Text>
          </Box>
          <Box mt="10">
            ...
            <Text>
              LifeHack 2022 will be a hybrid event. The main hackathon event
              from 4 - 10 July will be conducted online while the finale on 16
              July will be a physical event.
            </Text>
          </Box>
          <Box mt="10">
            <Heading size="lg">
            ...
            <Text>
              Your registration will be reviewed by our team soon. Upon
              reviewing all applications, we will notify you by email of the
              outcome of your registration.
            </Text>
          </Box>
          <Box mt="10">
            <Heading size="lg">
              Which platform will be used to disseminate event
              updates/announcements?
            </Heading>
            <Text>
              We will have a Discord server for participants to join and be
              updated of workshops or mini events throughout the hackathon.
            </Text>
            <Box mt="10">
              <Heading size="lg">
              ...
              <Text>
                You are allowed to use snippets of code you have previously
                written. However, copying your entire hack from previous events
                or from online is strictly not allowed.
              </Text>
            </Box>
            <Box mt="10">
              <Heading size="lg">How will the submissions be assessed?</Heading>
              <Text>
                Details on judging criteria and rules will be elaborated upon on
                the event Opening Day (9 July). Judging panels will consist of
                NUS professors and industry professionals.
              </Text>
            </Box>
            <Box mt="10">
              <Heading size="lg">
                Are there any restrictions on platforms and programming
                languages which can be used?
              </Heading>
              <Text>
                No. Feel free to use any programming language or technology
            ...
            <Box mt="10">
              ...
              <Text>
                Let us know at{' '}
                <a href="mailto:lifehack@nuscomputing.com">
